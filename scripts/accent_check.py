...
phoneme_list = Path("phoneme.txt").read_text().strip().replace("\t", " ").splitlines()

accent_start_list = (
    Path("emotion_accent_start.txt").read_text().replace("\t", " ").splitlines()
)

accent_end_list = (
    Path("emotion_accent_end.txt").read_text().replace("\t", " ").splitlines()
)

accent_phrase_start_list = (
    Path("emotion_accent_phrase_start.txt").read_text().replace("\t", " ").splitlines()
)

accent_phrase_end_list = (
    Path("emotion_accent_phrase_end.txt").read_text().replace("\t", " ").splitlines()
)
